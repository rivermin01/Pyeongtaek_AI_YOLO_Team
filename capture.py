...
def generate_frame():
    ...
    region = solutions.RegionCounter(
        ...
        # model='model_train_5/runs/detect/train2/weights/best.pt'                               # 학습시킨 맥용 경로
        # model = 'Pyeongtaek_AI_YOLO_Team\model_train_5\runs\detect\train2\weights\best.pt'     # 학습시킨 윈도우용 경로
    )
